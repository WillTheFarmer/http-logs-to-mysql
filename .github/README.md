...
***JSON data-driven*** App & growing number of MySQL schemas to automate import of files, build custom ***"file data ingestion methods"*** into database and generate a well-documented data lineage audit trail.
