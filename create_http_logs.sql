...
-- #
-- # version 4.0.0 - 01/21/2026 - separation of python app code and database schema code from http-logs-to-mysql repository - see changelog
-- #
-- # CHANGELOG.md in repository - https://github.com/WillTheFarmer/mysql-schema-http-logs
-- #
-- requires minimum versions MySQL 8.0.41 or MariaDB 10.5.26
...
CREATE TABLE `import_message` (
  ...
  added DATETIME NOT NULL DEFAULT NOW()
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COMMENT='Application Message log. Any errors that occur in MySQL processes will be here. Process messages or warnings can be here. This is a MyISAM engine table to avoid TRANSACTION ROLLBACKS. Always look in this table for problems!';-- # Start of file: log_tables.sql ---
-- drop table -----------------------------------------------------------
